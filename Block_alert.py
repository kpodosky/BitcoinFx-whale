...
KNOWN_WALLETS = {
    ...
    "3FHNBLobJnbCTFTVakh5TXmEneyf5PT61B": "Bitfinex",
    "385cR5DM96n1HvBDMzLHPYcw89fZAXULJP": "Kraken",
    "3ETfs8Wd3QcRvKPZghgYrPqcBkzWpwkrAx": "Bitframe",
    
    # DOJ Seized Wallets (as of latest known)
    "bc1q5shae2q9et4k2824ts8vqu0zwwlue4glrhr0qx": "DOJ-Seized-Silk-Road",
    "bc1qa5wkgaew2dkv56kfvj49j0av5nml45x9ek9hz6": "DOJ-Seized-2020",
    "1Cu2kh4M1ZXJNzjzBqoFs4Om3PFD6zQV2N": "DOJ-FTX-Related",
    ...
    # Investment Funds
    "385cR5DM96n1HvBDMzLHPYcw89fZAXULJP": "Grayscale-BTC-Trust",
    "3FHNBLobJnbCTFTVakh5TXmEneyf5PT61B": "Purpose-BTC-ETF",
    "12YyrZGF9QJGQipKrdUxk3jKvGtfE7jzXf": "3iQ-ETF",
    
    # Large Institutions
    "3BMEXxSMT2b2kvsnC4Q35d2kKJZ4u6xyNx": "Galaxy-Digital",
    "3KQ5tTEbhrwBjhv3WMgKzn8jQ7UvHQBNCk": "NYDIG",
    "36n452uGq1x4mK7bfyZR8wgE5qz9GwVDvu": "Celsius-Network",
    
    # Historical Addresses
    "1FeexV6bAHb8ybZjqQMjJrcCrHGW9sb6uF": "Silk-Road-Seized",
    "12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX": "Satoshi-Block-9",
    "1HLoD9E4SDFFPDiYfNYnkBLQ85Y51J3Zb1": "Mt.Gox-Cold",
    
    # Add more known addresses here as they are discovered
}
...
class BitcoinWhaleTracker:
    def __init__(self, min_btc=500):
        ...
        self.known_addresses = {
            ...
            'whales': {
                'type': 'private',
                'addresses': [
                    'bc1qm34lsc65zpw79lxes69zkqmk6ee3ewf0j77s3h',  # Unknown Whale 1
                    'bc1qf3qugf0c9vu4k9zsxqjgazxqwp3y6yrqh4686g',  # Unknown Whale 2
                ]
            },
            'miners': {
                'type': 'pool',
                'addresses': [
                    '1CK6KHY6MHgYvmRQ4PAafKYDrg1ejbH1cE',  # AntPool
                    '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',  # Genesis Mining
                    '12ib7dApVFvg82TXKycWBNpN8kFyiAN1dr',  # BTC.com Pool
                    '3Gpex6g5FPmYWm26myFq7dW12ntd8zMcCY',  # Foundry Pool
                ]
            },
            'institutions': {
                'type': 'corporate',
                'addresses': [
                    'bc1qazcm763858nkj2dj986etajv6wquslv8uxwczt',  # MicroStrategy Additional
                    'bc1qe7nps5yv7ruc884zscwrk9g2mxvqh7tkxfxwny',  # Grayscale Additional
                    '3BMEXxSMT2b2kvsnC4Q35d2kKJZ4u6xyNx',  # Galaxy Digital
                    '3KQ5tTEbhrwBjhv3WMgKzn8jQ7UvHQBNCk',  # NYDIG
                ]
            },
            'otc_desks': {
                'type': 'trading',
                'addresses': [
                    '3FHNBLobJnbCTFTVakh5TXmEneyf5PT61B',  # Cumberland
                    '3ETfs8Wd3QcRvKPZghgYrPqcBkzWpwkrAx',  # B2C2
                    '3QqKexPMiMnXvNSxj3kGJuaEMrDLTYmVfg',  # Genesis Trading
                ]
            },
            'defi': {
                'type': 'protocol',
                'addresses': [
                    'bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh',  # Curve Finance
                    'bc1q7kyrfmx49qa7n6g8mvlh36d4w9zf4lkwfg4j5q',  # Aave BTC Gateway
                    'bc1qd73dxk2qfs2x5wv2sesvqrzgx7t5tqt4y5vpym',  # Compound BTC Gateway
                ]
            },
            'historical': {
                'type': 'archive',
                'addresses': [
                    '1FeexV6bAHb8ybZjqQMjJrcCrHGW9sb6uF',  # Silk Road Seized
                    '12c6DSiU4Rq3P4ZxziKxzrL5LmMBrzjrJX',  # Satoshi Block 9
                    '1HLoD9E4SDFFPDiYfNYnkBLQ85Y51J3Zb1',  # Mt.Gox Cold Storage
                ]
            },
            'custodians': {
                'type': 'custody',
                'addresses': [
                    '385cR5DM96n1HvBDMzLHPYcw89fZAXULJP',  # BitGo
                    '3FHNBLobJnbCTFTVakh5TXmEneyf5PT61B',  # Copper
                    '3AgF6KovmZYyqtews1gUxZC4JPz74JTUE9',  # Fireblocks
                ]
            }
        }
    ...
    def get_entity_name(self, address: str) -> str:
        ...
        # Check in known_addresses dictionary first
        for entity, info in self.known_addresses.items():
            if address in info['addresses']:
                return entity.upper()
        
        # If not found in known_addresses, check KNOWN_WALLETS dictionary
        if address in KNOWN_WALLETS:
            return KNOWN_WALLETS[address]
            
        # If not found in either place, return "Unknown"
        return "Unknown"
    ...
    def identify_wallet(self, address):
        """Identify a wallet based on known addresses"""
        return self.known_wallets.get(address, "Unknown Wallet")
    ...
    def process_transaction(self, tx):
        ...
        try:
            ...
            if btc_volume >= self.min_btc:
                ...
                # Get entity names (will return "Unknown" if not recognized)
                sender_name = self.get_entity_name(sender)
                receiver_name = self.get_entity_name(receiver)
